...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen font-sans antialiased bg-gray-900 text-gray-200">

        <div class="relative overflow-hidden min-h-screen flex flex-col">
            <div class="absolute inset-0 opacity-20 bg-dot-pattern"></div>
            
            <header class="relative z-10 p-4 bg-white shadow-md">
                <div class="container mx-auto flex justify-between items-center">
                    <!-- Logo -->
                    <h1 class="text-xl font-semibold text-black">Mantaka</h1>
                        ...
                        <nav class="flex space-x-2">
                            @auth
                                <form method="POST" action="{{ route('logout') }}" class="inline">
                                    @csrf
                                    <button type="submit" class="px-3 py-1 bg-red-500 text-white text-sm rounded-md hover:bg-red-700 transition">
                                        Logout
                                    </button>
                                </form>
                            @else
                                <a href="{{ route('login') }}" class="px-3 py-1 text-sm text-black border border-gray-300 rounded-md hover:bg-gray-100 transition">
                                    Log in
                                </a>
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="px-3 py-1 text-sm text-black border border-gray-300 rounded-md hover:bg-gray-100 transition">
                                        Register
                                    </a>
                                @endif
                            @endauth
            ...
            <main class="pt-20">
                <section class="bg-gray-900">
                    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                        <div class="mr-auto place-self-center lg:col-span-7">
                            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-white">Manajemen Perpustakaan Modern</h1>
                            <p class="max-w-2xl mb-6 font-light text-gray-400 lg:mb-8 md:text-lg lg:text-xl">Mantaka menghadirkan solusi komprehensif untuk mengelola perpustakaan Anda dengan mudah dan efisien.</p>
                        </div>
                        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                            <img src="/api/placeholder/600/400" alt="mockup" class="rounded-lg shadow-2xl">
                        </div>
                    </div>
                </section>
                ...
                <section id="features" class="bg-gray-800 py-16">
                    <div class="max-w-screen-xl mx-auto px-4">
                        <h2 class="text-3xl font-bold text-center mb-12 text-white">Fitur Unggulan Mantaka</h2>
                        <div class="grid md:grid-cols-3 gap-8">
                            <div class="bg-gray-900 p-6 rounded-lg text-center">
                                ...
                                <h3 class="text-xl font-semibold mb-2 text-white">Manajemen Buku</h3>
                                <p class="text-gray-400">Kelola koleksi buku dengan mudah, tambah, hapus, dan perbarui informasi buku secara real-time.</p>
                            </div>
                            <div class="bg-gray-900 p-6 rounded-lg text-center">
                                <div class="flex justify-center mb-4">
                                    <svg class="w-12 h-12 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h3 class="text-xl font-semibold mb-2 text-white">Manajemen Anggota</h3>
                                <p class="text-gray-400">Kelola data anggota perpustakaan, riwayat peminjaman, dan profil dengan mudah.</p>
                            </div>
                            <div class="bg-gray-900 p-6 rounded-lg text-center">
                                <div class="flex justify-center mb-4">
                                    <svg class="w-12 h-12 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h3 class="text-xl font-semibold mb-2 text-white">Peminjaman & Pengembalian</h3>
                                <p class="text-gray-400">Sistem peminjaman dan pengembalian buku yang terintegrasi dan mudah digunakan.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="bg-gray-900 py-16">
                    <div class="max-w-screen-xl mx-auto px-4 text-center">
                        <h2 class="text-3xl font-bold mb-8 text-white">Kenapa Memilih Mantaka?</h2>
                        <div class="grid md:grid-cols-3 gap-8">
                            <div class="bg-gray-800 p-6 rounded-lg">
                                <h3 class="text-xl font-semibold mb-4 text-blue-500">Mudah Digunakan</h3>
                                <p class="text-gray-400">Antarmuka intuitif yang memudahkan pengelolaan perpustakaan.</p>
                            </div>
                            <div class="bg-gray-800 p-6 rounded-lg">
                                <h3 class="text-xl font-semibold mb-4 text-blue-500">Laporan Komprehensif</h3>
                                <p class="text-gray-400">Dapatkan insights mendalam tentang koleksi dan aktivitas perpustakaan.</p>
                            </div>
                            <div class="bg-gray-800 p-6 rounded-lg">
                                <h3 class="text-xl font-semibold mb-4 text-blue-500">Keamanan Terjamin</h3>
                                <p class="text-gray-400">Sistem keamanan canggih untuk melindungi data perpustakaan Anda.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="bg-gray-800 py-16">
                    <div class="max-w-screen-xl mx-auto px-4 text-center">
                        <h2 class="text-3xl font-bold mb-8 text-white">Siap Memulai?</h2>
                        <p class="text-gray-400 mb-8">Bergabunglah dengan ratusan perpustakaan yang sudah menggunakan Mantaka</p>
                    </div>
                </section>
            </main>
